...
RESEARCH = [
    ...
    ("기각", "순수 N개월 종가 신고가 돌파 (초하쌤 8/27, 9/7 검증) — 3·6·12개월 −0.05~+0.01R = 무작위 수준. 엣지는 '좁은 박스' 조건에서만(폭<30% +0.104R)"),
    ("기각", "급락(코스피 5일 −4%↓) 직후 상대강도 매수 (초하쌤 3/10) — 덜 빠진 상위 20% −0.100R, 많이 빠진 하위 −0.182R, 전체 −0.145R: 급락 후엔 어느 분위도 무작위보다 나쁨"),
    ("기각", "핫테마 내 덜 오른 종목 고르기 (초하쌤 1/21) — 지각 +0.109R vs 대장 +0.100R vs 중간 +0.123R, 차이 없음(264이벤트)"),
    ("기각", "50% 되돌림 매수 (초하쌤 11/5, 9/7 검증) — 랠리 +20%↑ 후 절반 눌림 5,805건: −0.005~+0.042R, 깊이(30/50/70%) 무관. 건진 것: 눌림 계열은 '랠리 저점 이탈' 손절 + 확인 진입이 나음"),
    ("기각", "60일선 부근 거래량 양봉 매수 (초하쌤 11/26, 9/7 검증) — 1,027건 −0.04~+0.04R, 거래량 ×3이면 더 나쁨(−0.03~−0.12R). 거래량 급증은 조건이 아니라 경고"),
    ("보류", "장기이평(224선 대체) 위 정배열 (초하쌤 3/10, 9/7 검증, 후반 1년 표본) — 무작위 진입에서 선 위 +0.064R vs 아래 −0.017R로 약한 긍정 필터, A급 안에선 차이 미미. '+30% 초과 비쌈'은 근거 약함. 448선·월봉은 캐시 4년 확장 후"),
    ("유망", "거래량 폭발일 청산 (초하쌤 9/17 '거래량 터지면 팔아라', 9/7 검증) — A급 4,819건에 청산만 변경: 목표 없이 거래량 20일평균 ×5 첫날 종가 청산 +0.189R vs 기준(+2R/20일) +0.128R, 전반/후반 모두 개선. ×2면 승률 51%·보유 6.9일. 계약 후 v2 청산 1순위"),
    ("유망", "시총 필터 (초하쌤 '1,000억 미만 금지', 9/7 검증) — A급 R이 시총과 단조: <500억 −0.40R · 1,000~5,000억 +0.01R · 5,000억~2조 +0.14R · 2조+ +0.25R. 1,000억 미만 회피 채택, '1,000~5,000억 스윗스팟'은 기각. 계약 후 v2 후보 'A급 × 5,000억+' (국면 효과 재검증 필요)"),
